...
const ModelDetils = () => {
  ...
  <div class="bg-[#1E293B]/70 backdrop-blur-lg rounded-2xl shadow-lg w-full max-w-3xl p-8 text-gray-200 border-2 border-amber-300 shadow-amber-50">
    ...
    <div class="w-full flex justify-center mb-6">
      <img src={image} alt="Model Image" class="rounded-2xl w-full sm:w-[80%] h-[250px] object-cover border border-[#6C63FF]/30 shadow-lg" />
    </div>


    <h1 class="text-3xl font-bold text-[#6C63FF] mb-4 text-center">{name}</h1>
    ...
    <div class="bg-[#0F172A]/70 p-5 rounded-lg border border-[#6C63FF]/30 mb-6">
      <h2 class="text-xl font-semibold text-[#00C9A7] mb-2">Description</h2>
    ...
    <div class="text-gray-400 text-sm mb-6 text-center">
      <p>Created By: <span class="text-[#00C9A7] font-medium">{createdBy}</span></p>
      <p>Created At: <span class="text-[#6C63FF]">{createdAt}</span></p>
    </div>
